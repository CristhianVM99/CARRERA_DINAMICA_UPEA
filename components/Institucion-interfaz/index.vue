    ...
    <section class="min-area">
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <div class="img">
              <img v-if="tipo == 'reglamentomodgraduacion'" class="thumparallax-down" :src="img_content" alt="" />                 
                <client-only v-if="
                ...
                <h5 v-if="
                tipo == 'calendarioacademico' && gaceta_documento!=null||
                tipo == 'horarios' && gaceta_documento!=null|| 
                tipo == 'calendarioacademico' && gaceta_documento!=null|| 
                tipo == 'plandeestudios' && gaceta_documento!=null
                "
                style="text-align: center;"
                >{{ documento[0].gaceta_titulo }}</h5>
                <h3 v-if="documento == 0 " style="text-align: center;color: var(--color-secundario);">No hay Registros</h3>             
            </div>
          </div>
          <div class="col-lg-6 valign" style="margin: 100px 0px;">
            <div class="content">
              ...
              <p v-if="
                ...
                tipo == 'calendarioacademico' || 
                tipo == 'plandeestudios' 
                " class="wow txt words chars splitting" data-splitting>
                {{ content }}
              </p>
              <div 
                ...
                ></div>
                <span  v-if="tipo == 'reglamentomodgraduacion'" @click="cambiarTamanoTexto" class="butn bord curve mt-30">
              ...
              tipo == 'calendarioacademico' || 
              tipo == 'plandeestudios'
              " target="_blank" :href="url_api + '/Gaceta/' + documento[0].gaceta_documento" class="butn bord curve mt-30">
                Descargar PDF
              </a>  
              <br />
            </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        content_reglamento : useInstitucionStore().institucion.institucion_sobre_ins,
