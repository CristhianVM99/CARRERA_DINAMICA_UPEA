    ...
    <div class="">
      ...
      >
        ...
        <div class="blog1 col-lg-12">
          ...
          >
            <div class="img valign">
              <img class="img_conv" :src="url_api + '/Convocatorias/' + conv.con_foto_portada" :alt="conv.con_titulo" />
            </div>
        ...
        <div class="blog2 col-lg-12">
          ...
          >
            <div class="img valign">
              <img class="img_conv" :src="url_api + '/Convocatorias/' + com.con_foto_portada" alt="" />
            </div>
            <div class="cont valign">
              <div>
                <div class="info">
        ...
        <div class="blog3 col-lg-12">
          ...
          >
            <div class="img valign">
              <img class="img_conv" :src="url_api + '/Convocatorias/' + avi.con_foto_portada" alt="" />
            </div>
            <div class="cont valign">
              <div>
                <div class="info">
      ...
      <div v-if="(tipo=='cursos')" class="row">        
        <div class="blog4 col-lg-12">
          <div class="col-lg-6 offset-lg-1 conv_blog3">
          <div class="item wow fadeInUp" data-wow-delay=".3s"
          v-for="(cur) in carrera_cursos.slice(0, 1)" :key="encryptID(cur.iddetalle_cursos_academicos)"
          >
            <div class="img valign">
              <img class="img_conv" :src="url_api + '/Cursos/' + cur.det_img_portada" alt="" />
            </div>
            <div class="cont valign">
              <div>
                <div class="info">
        ...
        <div class="blog5 col-lg-12">
          <div class="col-lg-6 offset-lg-1 conv_blog3">          
          <div class="item wow fadeInUp" data-wow-delay=".5s"
          v-for="(sem) in carrera_seminarios.slice(0, 1)" :key="encryptID(sem.iddetalle_cursos_academicos)"
          >
            <div class="img valign">
              <img class="img_conv" :src="url_api + '/Cursos/' + sem.det_img_portada" alt="" />
            </div>
            <div class="cont valign">
              <div>
                <div class="info">
