      ...
      <div class="row">
        <div class="col-lg-4" v-for="(conv) in carrera_convocatorias.slice(0, 1)" :key="encryptID(conv.idconvocatorias)">
          <div class="item md-mb50 wow fadeInUp" data-wow-delay=".3s">
            <div class="img">
              <img class="img-style" :src="url_api + '/Convocatorias/' + conv.con_foto_portada" :alt="conv.con_titulo" />
              <!-- 1000x560-->
            </div>
            <div class="cont">
              <div>
    ...
    <div class="container" v-if="tipo == 'autoridades'">
      ...
      <div class="row">
        <div class="col-lg-4" v-for="(aut) in institucion.autoridad" :key="encryptID(aut.id_autoridad)">
          <div class="item md-mb50 wow fadeInUp" data-wow-delay=".3s">
            <div class="img">
              <img class="img-style" :src="url_api + '/InstitucionUpea/Autoridad/' + aut.foto_autoridad" :alt="aut.nombre_autoridad" />
            </div>
            <div class="cont">
              <div>
                <div class="info">
