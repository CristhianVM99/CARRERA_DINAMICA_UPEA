<template>
  <header class="slider-stwo valign position-re">
    <div class="container banner_intro3">
      <div class="row">
        <div class="col-lg-5">
          <div class="img">
            <img :src="url_api + '/InstitucionUpea/Portada/' + portadas[portadas.length - 1].portada_imagen" :alt="carrera_nombre" />
          </div>
        </div>
        <div class="col-lg-7 valign">
          <div class="cont">
            <div class="sub-title mb-5">
              <h6 style="color: #fff;">{{ carrera_iniciales }}</h6>
            </div>
            <h1 class="mb-10 fw-600">Carrera de <span style="color:var(--color-secundario);">{{ carrera_nombre }}</span></h1>
            <p>
              {{ text_banner }}
            </p>
            <ul>
              <li style="margin-right: 3px;">
                <div>
                  <span class="icon pe-7s-study">
                    <div class="bord"></div>
                  </span>
                </div>
                <div class="cont">
                  <h6>Trayectoria Exitosa</h6>
                  <p>
              ...
              <li>
                <div>
                  <span class="icon pe-7s-id">
                    <div class="bord"></div>
                  </span>
                </div>
                <div class="cont">
                  <h6>Carrera Brillante</h6>
                  <p>
            ...
            <NuxtLink class="butn bord curve mt-30" style="background: var(--color-secundario); color: #fff;border: none;" to="/categorias">
