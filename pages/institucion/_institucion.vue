<template>
    <div>
      ...
      <div class="wrapper">
        ...
        <InstitucionInterfaz v-if="layout==1" :documento="documento" :title="title_introduccion" :content="content_introduccion" :carrera="carrera" :tipo="$route.params.institucion"/>        
        <WorksStyle2 v-if="layout==2" :documentos="documento" :title="title_introduccion" :content="content_introduccion" :carrera="carrera" :grid="3" filterPosition="center" :tipo="$route.params.institucion"/>
        <Footer />
      </div>    
    </div>
  </template>
  ...
  export default {
    ...
    data() {
      return {      
        ...
        title_calendario_academico: useInstitucionStore().title_calendario_academico,
        content_calendario_academico: useInstitucionStore().content_calendario_academico,    
        title_horario_academico: useInstitucionStore().title_horario_academico,
        content_horario_academico: useInstitucionStore().content_horario_academico,    
        ...
        title_reglamento_mod_graduacion: useInstitucionStore().title_reglamento_mod_graduacion,
        content_reglamento_mod_graduacion: useInstitucionStore().content_reglamento_mod_graduacion,    
        title_convenios_institucionales: useInstitucionStore().title_convenios_institucionales,
        content_convenios_institucionales: useInstitucionStore().content_convenios_institucionales,    
        ...
        content_trabajos_dirigidos: useInstitucionStore().content_trabajos_dirigidos,
        documento: null,
        layout: 1,
      ...
      getInstitucion(){
        switch (this.$route.params.institucion) {
          case "calendarioacademico":
            ...
            this.documento = useInstitucionStore().carrera_gacetas.filter(e => e.gaceta_titulo.includes('CALENDARIO'))            
            this.layout = 1
            break;          
            case "horarios":
            ...
            this.documento = useInstitucionStore().carrera_gacetas.filter(e => e.gaceta_titulo.includes('HORARIO'))            
            this.layout = 1
            break;          
            case "plandeestudios":
            ...
            this.documento = useInstitucionStore().carrera_gacetas.filter(e => e.gaceta_titulo.includes('PLAN'))            
            this.layout = 1
            break;          
            ...
            this.documento = useInstitucionStore().carrera_gacetas.filter(e => e.gaceta_titulo.includes('CONVENIO'))            
            this.layout = 2
            break;          
            case "pasantias":
            ...
            this.documento = useInstitucionStore().carrera_gacetas.filter(e => e.gaceta_titulo.includes('PASANTIA'))            
            this.layout = 2
            break;          
            ...
            this.documento = useInstitucionStore().carrera_gacetas.filter(e => e.gaceta_titulo.includes('TRABAJO DIRIGIDO'))            
            this.layout = 2
            break;          
          default:
            break;
